...
<div itemscope itemtype="http://schema.org/Organization" style="position: absolute; visibility: hidden;">
    ...
    <section class="unique-feature-area section-gap" id="unique">
            <div class="container">
                ...
                <div class="row">
                    <div class="scroll active" data-step="1">
                        <div class="single-unique-product item">
                            <img class="img-fluid" 
                            src="{{ Storage::disk('assets')->url('cleankirov/images/u1.jpg') }}" 
                            alt="{{$company->description}}">
                            <div class="desc">
                                <h5>
                                    Химчистка мебели
                                </h5>
                                <a class="text-uppercase primary-btn mt-3 first" href="#" data-type="mebel">Рассчитать стоимость</a>
                            </div>
                        </div>
                        <div class="single-unique-product item">
                            <img class="img-fluid" 
                            src="{{ Storage::disk('assets')->url('cleankirov/images/u4.jpg') }}" 
                            alt="{{$company->description}}">
                            <div class="desc">
                                <h5>
                                    Химчистка матрацов
                                </h5>
                                <a class="text-uppercase primary-btn mt-3 first" href="#" data-type="matras">Рассчитать стоимость</a>
                            </div>
                        </div>
                        <div class="single-unique-product item">
                            <img class="img-fluid" 
                            src="{{ Storage::disk('assets')->url('cleankirov/images/u3.jpg') }}" 
                            alt="{{$company->description}}">
                            <div class="desc">
                                <h5>
                                    Химчистка стульев/кресел
                                </h5>
                                <a class="text-uppercase primary-btn mt-3 first" href="#" data-type="chairs">Рассчитать стоимость</a>
                            </div>
                        </div>
                        <div class="single-unique-product item">
                            <img class="img-fluid" 
                            src="{{ Storage::disk('assets')->url('cleankirov/images/u2.jpg') }}" 
                            alt="{{$company->description}}">
                            <div class="desc">
                                <h5>
                                    Химчистка ковров/ковролина
                                </h5>
                                <a class="text-uppercase primary-btn mt-3 first" href="#" data-type="carpet">Рассчитать стоимость</a>
                            </div>
                        </div>

                    </div>
                    <div class="scroll" data-step="mebel">

                        <div class="single-unique-product item item-prop">
                            <img class="img-fluid" 
                            src="{{ Storage::disk('assets')->url('cleankirov/images/u5.jpg') }}" 
                            alt="{{$company->description}}">
                            <div class="desc">
                                <h5>
                                    2-х местный диван(~120 см)
                                </h5>
                                <a class="text-uppercase primary-btn mt-3" href="#" data-item="2-х местный диван(~120 см)" data-type="mebel">Выбрать</a>
                            </div>
                        </div>
                        <div class="single-unique-product item item-prop">
                            <img class="img-fluid" 
                            src="{{ Storage::disk('assets')->url('cleankirov/images/u6.jpg') }}" 
                            alt="{{$company->description}}">
                            <div class="desc">
                                <h5>
                                    Трехместный диван, нераскладной (~180 см)
                                </h5>
                                <a class="text-uppercase primary-btn mt-3" href="#" data-item="Трехместный диван, нераскладной" data-type="mebel">Выбрать</a>
                            </div>
                        </div>
                        <div class="single-unique-product item item-prop">
                            <img class="img-fluid" 
                            src="{{ Storage::disk('assets')->url('cleankirov/images/u7.jpg') }}" 
                            alt="{{$company->description}}">
                            <div class="desc">
                                <h5>
                                    Диван-книжка (~200 см)
                                </h5>
                                <a class="text-uppercase primary-btn mt-3" href="#" data-item="Диван-книжка">Выбрать</a>
                            </div>
                        </div>
                        <div class="single-unique-product item item-prop">
                            <img class="img-fluid" 
                            src="{{ Storage::disk('assets')->url('cleankirov/images/u8.jpg') }}" 
                            alt="{{$company->description}}">
                            <div class="desc">
                                <h5>
                                    Угловой диван с выдвижным спальным местом
                                </h5>
                                <a class="text-uppercase primary-btn mt-3" href="#" data-item="Угловой диван с выдвижным спальным местом">Выбрать</a>
                            </div>
                        </div>
                        <div class="single-unique-product item item-prop">
                            <img class="img-fluid" 
                            src="{{ Storage::disk('assets')->url('cleankirov/images/u9.jpg') }}" 
                            alt="{{$company->description}}">
                            <div class="desc">
                                <h5>
                                    Диван двухместный с выдвижным спальным местом
                                </h5>
                                <a class="text-uppercase primary-btn mt-3" href="#" data-item="двухместный с выдвижным спальным местом">Выбрать</a>
                            </div>
                        </div>
                        <div class="single-unique-product item item-prop">
                            <img class="img-fluid" 
                            src="{{ Storage::disk('assets')->url('cleankirov/images/u10.jpg') }}" 
                            alt="{{$company->description}}">
                            <div class="desc">
                                <h5>
                                    Трехместный див��н с раскладным матрасом (матрас тоже нужно чистить)
                                </h5>
                                <a class="text-uppercase primary-btn mt-3" href="#" data-item="Трехместный диван с раскладным матрасом">Выбрать</a>
                            </div>
                        </div>
                        <div class="single-unique-product item item-prop">
                            <img class="img-fluid" 
                            src="{{ Storage::disk('assets')->url('cleankirov/images/u11.jpg') }}" 
                            alt="{{$company->description}}">
                            <div class="desc">
                                <h5>
                                    П-образный диван или любой другой более 5 посадочных мест
                                </h5>
                                <a class="text-uppercase primary-btn mt-3" href="#" data-item="П-образный диван">Выбрать</a>
                            </div>
                        </div>
                    </div>
                    <div class="scroll" data-step="matras">

                        <div class="single-unique-product item item-prop">
                            <img class="img-fluid" 
                            src="{{ Storage::disk('assets')->url('cleankirov/images/u12.jpg') }}" 
                            alt="{{$company->description}}">
                            <div class="desc">
                                <h5>
                                    Односпальный матрас (шириной до 80 см)
                                </h5>
                                <a class="text-uppercase primary-btn mt-3" href="#" data-item="Односпальный матрас">Выбрать</a>
                            </div>
                        </div>
                        <div class="single-unique-product item item-prop">
                            <img class="img-fluid" 
                            src="{{ Storage::disk('assets')->url('cleankirov/images/u13.jpg') }}" 
                            alt="{{$company->description}}">
                            <div class="desc">
                                <h5>
                                    Полуторный матрас (шириной до 120 см)
                                </h5>
                                <a class="text-uppercase primary-btn mt-3" href="#" data-item="Полуторный матрас">Выбрать</a>
                            </div>
                        </div>
                        <div class="single-unique-product item item-prop">
                            <img class="img-fluid" 
                            src="{{ Storage::disk('assets')->url('cleankirov/images/u14.jpg') }}" 
                            alt="{{$company->description}}">
                            <div class="desc">
                                <h5>
                                    Двуспальный матрас (шириной до 160 см)
                                </h5>
                                <a class="text-uppercase primary-btn mt-3" href="#" data-item="Двуспальный матрас">Выбрать</a>
                            </div>
                        </div>
                        <div class="single-unique-product item item-prop">
                            <img class="img-fluid" 
                            src="{{ Storage::disk('assets')->url('cleankirov/images/u15.jpg') }}" 
                            alt="{{$company->description}}">
                            <div class="desc">
                                <h5>
                                    King size (ширина 180-220 см)
                                </h5>
                                <a class="text-uppercase primary-btn mt-3" href="#" data-item="King size">Выбрать</a>
                            </div>
                        </div>
                        <div class="single-unique-product item item-prop">
                            <img class="img-fluid" 
                            src="{{ Storage::disk('assets')->url('cleankirov/images/u16.jpg') }}" 
                            alt="{{$company->description}}">
                            <div class="desc">
                                <h5>
                                    Матрас грудничка (в люльку)
                                </h5>
                                <a class="text-uppercase primary-btn mt-3" href="#" data-item="Матрас грудничка">Выбрать</a>
                            </div>
                        </div>
                    </div>
                    <div class="scroll" data-step="chairs">

                        <div class="single-unique-product item item-prop">
                            <img class="img-fluid" 
                            src="{{ Storage::disk('assets')->url('cleankirov/images/u17.jpg') }}" 
                            alt="{{$company->description}}">
                            <div class="desc">
                                <h5>
                                    Стул с деревянной спинкой
                                </h5>
                                <a class="text-uppercase primary-btn mt-3" href="#" data-item="Стул с деревянной спинкой">Выбрать</a>
                            </div>
                        </div>
                        <div class="single-unique-product item item-prop">
                            <img class="img-fluid" 
                            src="{{ Storage::disk('assets')->url('cleankirov/images/u18.jpg') }}" 
                            alt="{{$company->description}}">
                            <div class="desc">
                                <h5>
                                    Стул с тканевым сидением и спинкой
                                </h5>
                                <a class="text-uppercase primary-btn mt-3" href="#" data-item="Стул с тканевым сидением и спинкой">Выбрать</a>
                            </div>
                        </div>
                        <div class="single-unique-product item item-prop">
                            <img class="img-fluid" 
                            src="{{ Storage::disk('assets')->url('cleankirov/images/u19.jpg') }}" 
                            alt="{{$company->description}}">
                            <div class="desc">
                                <h5>
                                    Кресло стандартных размеров
                                </h5>
                                <a class="text-uppercase primary-btn mt-3" href="#" data-item="Кресло стандартных размеров">Выбрать</a>
                            </div>
                        </div>
                        <div class="single-unique-product item item-prop">
                            <img class="img-fluid" 
                            src="{{ Storage::disk('assets')->url('cleankirov/images/u20.jpg') }}" 
                            alt="{{$company->description}}">
                            <div class="desc">
                                <h5>
                                    Объемное кресло
                                </h5>
                                <a class="text-uppercase primary-btn mt-3" href="#" data-item="Объемное кресло">Выбрать</a>
                            </div>
                        </div>
                        <div class="single-unique-product item item-prop">
                            <img class="img-fluid" 
                            src="{{ Storage::disk('assets')->url('cleankirov/images/u21.jpg') }}" 
                            alt="{{$company->description}}">
                            <div class="desc">
                                <h5>
                                    Компьютерное кресло
                                </h5>
                                <a class="text-uppercase primary-btn mt-3" href="#" data-item="Компьютерное кресло">Выбрать</a>
                            </div>
                        </div>
                    </div>
                    <div class="scroll" data-step="carpet">

                        <div class="single-unique-product item item-prop">
                            <img class="img-fluid" 
                            src="{{ Storage::disk('assets')->url('cleankirov/images/u22.jpg') }}" 
                            alt="{{$company->description}}">
                            <div class="desc">
                                <h5>
                                    Синтетический ковер с коротким ворсом
                                </h5>
                                <a class="text-uppercase primary-btn mt-3" href="#" data-item="Синтетический ковер с коротким ворсом">Выбрать</a>
                            </div>
                        </div>
                        <div class="single-unique-product item item-prop">
                            <img class="img-fluid" 
                            src="{{ Storage::disk('assets')->url('cleankirov/images/u23.jpg') }}" 
                            alt="{{$company->description}}">
                            <div class="desc">
                                <h5>
                                    Шерстяной ковер с коротким <br>ворсом
                                </h5>
                                <a class="text-uppercase primary-btn mt-3" href="#" data-item="Шерстяной ковер с коротким ворсом">Выбрать</a>
                            </div>
                        </div>
                        <div class="single-unique-product item item-prop">
                            <img class="img-fluid" 
                            src="{{ Storage::disk('assets')->url('cleankirov/images/u24.jpg') }}" 
                            alt="{{$company->description}}">
                            <div class="desc">
                                <h5>
                                    Ковер с высоким ворсом (шегги)
                                </h5>
                                <a class="text-uppercase primary-btn mt-3" href="#" data-item="Ковер с высоким ворсом (шегги)">Выбрать</a>
                            </div>
                        </div>
                        <div class="single-unique-product item item-prop">
                            <img class="img-fluid" 
                            src="{{ Storage::disk('assets')->url('cleankirov/images/u25.jpg') }}" 
                            alt="{{$company->description}}">
                            <div class="desc">
                                <h5>
                                    Ковролин с коротким ворсом
                                </h5>
                                <a class="text-uppercase primary-btn mt-3" href="#" data-item="Ковролин с коротким ворсом">Выбрать</a>
                            </div>
                        </div>
                        <div class="single-unique-product item item-prop">
                            <img class="img-fluid" 
                            src="{{ Storage::disk('assets')->url('cleankirov/images/u26.jpg') }}" 
                            alt="{{$company->description}}">
                            <div class="desc">
                                <h5>
                                    Ковролин с высоким ворсом
                                </h5>
                                <a class="text-uppercase primary-btn mt-3" href="#" data-item="Ковролин с высоким ворсом">Выбрать</a>
                            </div>
                        </div>
                    </div>
                    <div class="scroll" data-step="zagryaznenie">
                        <div class="single-unique-product text-left item" style="width: 350px;background: transparent;">
                            <div class="desc d-flex align-items-center justify-content-start" style="height: 100%;background: transparent;">
                                <div>
                                    <h3 class="text-white">Присутствует ли неприятный запах <br>(например, от животных)?</h3>
                                    <div class="radio mt-5">
                                        <div class="form-check d-flexalign-items-end mb-3">
                                            <input style="width: 20px;height: 20px;" class="form-check-input" value="есть запах" type="radio" name="flexRadioDefault" id="flexRadioDefault1">
                                            <label class="text-white form-check-label ml-3" style="font-size: 20px" for="flexRadioDefault1">
                                                Есть
                                            </label>
                                        </div>
                                        <div class="form-check d-flex align-items-end">
                                            <input style="width: 20px;height: 20px;" class="form-check-input" value="нет запаха" type="radio" name="flexRadioDefault" id="flexRadioDefault2" checked>
                                            <label class="text-white form-check-label ml-3" style="font-size: 20px" for="flexRadioDefault2">
                                                Нет
                                            </label>
                                        </div>
                                    </div>
                    ...
                    <div class="scroll" data-step="typeofzagryaznenie">
                        <div class="single-unique-product text-left item" style="width: 350px;background: transparent;">
                            <div class="desc d-flex align-items-center justify-content-start" style="height: 100%;background: transparent;">
                                <div class="checkboxes">
                                    <h3 class="text-white">Есть ли какие-то из перечисленных ниже загрязнений?</h3>
                                    <div class="form-check mt-5">
                                        <input class="form-check-input" type="checkbox" name="Пыль, грязь" value="Пыль, грязь" id="firstCheck" checked>
                                        <label class="form-check-label" for="firstCheck">Пыль, грязь</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="Кровь" value="Кровь" id="thirdCheck">
                                        <label class="form-check-label" for="thirdCheck">Кровь</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="Краска" value="Краска" id="secondCheck" >
                                        <label class="form-check-label" for="secondCheck">Краска</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="Чернила" value="Чернила" id="fourCheck" checked>
                                        <label class="form-check-label" for="fourCheck">Чернила</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="Пластилин или лизун" value="Пластилин или лизун" id="fiveCheck" >
                                        <label class="form-check-label" for="fiveCheck">Пластилин или лизун</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="Моча" value="Моча" id="sixCheck">
                                        <label class="form-check-label" for="sixCheck">Моча</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="Плесень" value="Плесень" id="sevenCheck">
                                        <label class="form-check-label" for="sevenCheck">Плесень</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="scroll" data-step="contact-info">
                        <div class="single-unique-product text-left item" style="width: 350px;background: transparent;">
                            <div class="desc d-flex align-items-center justify-content-start" style="height: 100%;background: transparent;">
                                <div>
                                    <h3 class="text-white">Оставьте свои контактные данные</h3>
                                    <p class="text-white">Заполните поля ниже, чтобы мы знали как к вам обращаться</p>
                                    <div class="contact-panel mt-5">
                                        <div class="form-group">
                                            <label for="name" class="text-white">Имя</label>
                                            <input type="text" name="name" data-name="Имя клиента" class="form-control" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="phone" class="text-white">Номер телефона</label>
                                            <input type="text" id="phone" placeholder="+7 (___) ___-__-__" name="phone" data-name="Номер телефона" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12">
                        <button class="primary-btn text-uppercase mt-3 to-start" style="opacity: 0;transition: all 0.3s;margin-right: 10px;">В начало</button>
                        <button class="primary-btn text-uppercase mt-3 smell-step" style="display: none">Далее</button>
                        <button class="primary-btn text-uppercase mt-3 type-step" style="display: none">Далее</button>
                        <button class="primary-btn text-uppercase mt-3 contact-step" style="display: none">Отправить</button>
                    </div>
                </div>
            </div>
    </section>
